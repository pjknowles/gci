...
size_t hash_mc1_sym(const VibExcitation &exc, int nModal) {
    size_t A = exc.excitations[0][0];
    size_t n = std::max(exc.excitations[0][1], exc.excitations[0][2]);
    size_t m = std::min(exc.excitations[0][1], exc.excitations[0][2]);
...
size_t hash_mc1_nosym(const VibExcitation &exc, int nModal) {
    size_t A = exc.excitations[0][0];
    size_t i = exc.excitations[0][1];
    size_t j = exc.excitations[0][2];
