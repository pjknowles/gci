...
SymmetryMatrix::Operator Wavefunction::density(int rank,
  ...
  SymmetryMatrix::Operator result(SymmetryMatrix::dims_t{dim,dim,dim,dim}, rank, uhf, (hermitian ? std::vector<int>{1,1} : std::vector<int>{0,0}), {-1,-1}, symmetry ^ bra->symmetry, false, false, description);
