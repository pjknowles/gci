...
public:
  HProductF()
      : nMode(4), nModal(5), excLvl(3), mode1(0), mode2(2), mode3(3), modal1(1), modal2(3), modal3(4),
        vibSpace(nMode, nModal, excLvl), product({{mode1, modal1}, {mode2, modal2}, {mode3, modal3}}){};
