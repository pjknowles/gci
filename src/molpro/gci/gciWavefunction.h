...
public:
    ...
    void diagonalOperator(
            const molpro::Operator &op); ///< set this object to the diagonal elements of the hamiltonian
    ...
    /*!
       ...
       */
    void
    operatorOnWavefunction(const molpro::Operator &h, const Wavefunction &w, bool parallel_stringset = false);
     ...
     * \return
     */
    molpro::Operator density(int rank = 2,
                                     bool uhf = false,
                                     bool hermitian = true,
