...
void MxmDrvTN(double *Out, const double *A, const double *B, uint nRows, uint nLink, uint nStrideLink, uint nCols,
              bool AddToDest = false);
// as above, but for C = A B
void MxmDrvNN(double *Out, const double *A, const double *B, uint nRows, uint nLink, uint nCols,
              bool AddToDest = false);
...
void MxmDrvGen(double *Out, uint nRowStOut, uint nColStOut, const double *A, uint nRowStA, uint nColStA,
               const double *B, uint nRowStB, uint nColStB, uint nRows, uint nLink, uint nCols, bool AddToDest = false);
...
void MxmDrvGenF(double *Out, uint nRowStOut, uint nColStOut, const double *A, uint nRowStA, uint nColStA,
                const double *B, uint nRowStB, uint nColStB, uint nRows, uint nLink, uint nCols, bool AddToDest,
                double Factor);

// also a generic driver for mxva/b
void MxvDrvGen(const double *A, uint nRowStA, uint nColStA, const double *V, uint nStrideV, double *R, uint nStrideR,
